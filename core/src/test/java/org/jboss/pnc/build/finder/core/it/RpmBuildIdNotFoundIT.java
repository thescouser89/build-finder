...
class RpmBuildIdNotFoundIT extends AbstractRpmIT {
    public static final Logger LOGGER = LoggerFactory.getLogger(RpmBuildIdNotFoundIT.class);
                ...
                contains(
                        allOf(
                                ...
                                hasProperty(
                                        "checksums",
                                        contains(hasProperty("value", is("84ed0982a77b1c3a0c093409eb19c8ab")))))));
        assertThat(builds.get(new BuildSystemInteger(0)).getRpms(), contains(hasProperty("name", is("libdnf"))));
